...
<body>
  <header class="cabezaReserva">
    ...
    <a href="{{route('ObtenerInformacionReservas')}}" class="etiqueta">Regresar</a>
...
<button type="button" class="botonReserva" disabled data-bs-toggle="modal" data-bs-target="#modalReserva">Confirmar Nuevo Asiento</button>
...
<script>
  $(document).ready(function () {
    ...
    $("#reservar").submit(function (event) {
      ...
      formData += "&asiento_new=" + numeroAsiento;

      $.ajax({
        url: "{{route('CambiarReserva')}}",
        type: "PUT",
        data: formData,
        success: function (data) {
          mostrarModalExito();
          setTimeout(function () {
            window.location.href="{{route('ObtenerInformacionReservas')}}";
          }, 1000);
        },
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ¡La reserva se actualizó con éxito!
      </div>
      <div class="modal-footer">
